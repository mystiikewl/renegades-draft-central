...
// --- Module mocks: api + auth only; layout & pick-flow logic runs for real ---
...
describe('PlayerPoolPage', () => {
  ...
  it("shows the on-clock banner; your-turn copy when it is your pick", () => {
    ...
    expect(screen.getByText('YOUR PICK — draft below')).toBeInTheDocument();
  });
  ...
  it("no pick button in the dialog when it isn't your turn", async () => {
    const user = userEvent.setup();
