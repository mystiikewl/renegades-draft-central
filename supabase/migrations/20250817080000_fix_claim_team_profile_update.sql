-- Fix the claim_team function to update the correct column (user_id instead of id) in public.profiles
...
begin
  ...
  where user_id = current_user_id; -- Changed from 'id' to 'user_id'
